...
final class PerfumeCatalog
{
    ...
    /**
     * Merge the German base name with English/Arabic overrides, falling back to
     * the German name whenever a locale is missing.
     *
     * @param  array{en?: string, ar?: string}  $overrides
     * @return array{de: string, en: string, ar: string}
     */
    public static function localized(string $german, array $overrides): array
    {
        return [
            'de' => $german,
            'en' => $overrides['en'] ?? $german,
            'ar' => $overrides['ar'] ?? $german,
        ];
    }

    /**
     * English and Arabic names keyed by category slug.
     *
     * @return array<string, array{en: string, ar: string}>
     */
    public static function categoryTranslations(): array
    {
        return [
            'damenparfums' => ['en' => "Women's Perfumes", 'ar' => 'عطور نسائية'],
            'herrenparfums' => ['en' => "Men's Perfumes", 'ar' => 'عطور رجالية'],
            'unisex-parfums' => ['en' => 'Unisex Perfumes', 'ar' => 'عطور للجنسين'],
            'luxusparfums' => ['en' => 'Luxury Perfumes', 'ar' => 'عطور فاخرة'],
        ];
    }

    /**
     * English and Arabic names keyed by attribute code.
     *
     * @return array<string, array{en: string, ar: string}>
     */
    ...
    {
        return [
            'art' => ['en' => 'Type', 'ar' => 'النوع'],
            'familie' => ['en' => 'Fragrance Family', 'ar' => 'العائلة العطرية'],
            'stimmung' => ['en' => 'Mood', 'ar' => 'المزاج'],
            'noten' => ['en' => 'Notes', 'ar' => 'النفحات'],
        ];
    }

    /**
     * English and Arabic names keyed by attribute value slug. Slugs are unique
     * by meaning across attributes, so a flat map is safe.
     *
     * @return array<string, array{en: string, ar: string}>
     */
    public static function attributeValueTranslations(): array
    {
        return [
            // art
            'designer' => ['en' => 'Designer', 'ar' => 'ديزاينر'],
            'nische' => ['en' => 'Niche', 'ar' => 'نيش'],
            'luxus' => ['en' => 'Luxury', 'ar' => 'فاخر'],

            // familie
            'orientalisch' => ['en' => 'Oriental', 'ar' => 'شرقي'],
            'gourmand' => ['en' => 'Gourmand', 'ar' => 'حلوياتي'],
            'blumig' => ['en' => 'Floral', 'ar' => 'زهري'],
            'fruchtig' => ['en' => 'Fruity', 'ar' => 'فواكهي'],
            'zitrisch' => ['en' => 'Citrus', 'ar' => 'حمضي'],
            'holzig' => ['en' => 'Woody', 'ar' => 'خشبي'],
            'pudrig' => ['en' => 'Powdery', 'ar' => 'بودري'],
            'aromatisch' => ['en' => 'Aromatic', 'ar' => 'أروماتي'],
            'aquatisch' => ['en' => 'Aquatic', 'ar' => 'مائي'],
            'frisch' => ['en' => 'Fresh', 'ar' => 'منعش'],
            'ledrig' => ['en' => 'Leathery', 'ar' => 'جلدي'],
            'wuerzig' => ['en' => 'Spicy', 'ar' => 'توابلي'],
            'tabak' => ['en' => 'Tobacco', 'ar' => 'تبغ'],

            // stimmung
            'sinnlich' => ['en' => 'Sensual', 'ar' => 'حسي'],
            'anziehend' => ['en' => 'Attractive', 'ar' => 'جذاب'],
            'luxurioes' => ['en' => 'Luxurious', 'ar' => 'فخم'],
            'feminin' => ['en' => 'Feminine', 'ar' => 'أنثوي'],
            'elegant' => ['en' => 'Elegant', 'ar' => 'أنيق'],
            'exklusiv' => ['en' => 'Exclusive', 'ar' => 'حصري'],
            'selbstbewusst' => ['en' => 'Confident', 'ar' => 'واثق'],
            'sportlich' => ['en' => 'Sporty', 'ar' => 'رياضي'],
            'charismatisch' => ['en' => 'Charismatic', 'ar' => 'كاريزمي'],
            'modern' => ['en' => 'Modern', 'ar' => 'عصري'],
            'professionell' => ['en' => 'Professional', 'ar' => 'احترافي'],
            'klassisch' => ['en' => 'Classic', 'ar' => 'كلاسيكي'],
            'sauber' => ['en' => 'Clean', 'ar' => 'نظيف'],
            'dunkel' => ['en' => 'Dark', 'ar' => 'داكن'],
            'unvergesslich' => ['en' => 'Unforgettable', 'ar' => 'لا يُنسى'],
            'intensiv' => ['en' => 'Intense', 'ar' => 'كثيف'],
            'jugendlich' => ['en' => 'Youthful', 'ar' => 'شبابي'],
            'maskulin' => ['en' => 'Masculine', 'ar' => 'رجولي'],
            'warm' => ['en' => 'Warm', 'ar' => 'دافئ'],
            'raffiniert' => ['en' => 'Refined', 'ar' => 'راقٍ'],

            // noten
            'blutorange' => ['en' => 'Blood Orange', 'ar' => 'برتقال أحمر'],
            'gardenie' => ['en' => 'Gardenia', 'ar' => 'غردينيا'],
            'honig' => ['en' => 'Honey', 'ar' => 'عسل'],
            'patchouli' => ['en' => 'Patchouli', 'ar' => 'باتشولي'],
            'baiser' => ['en' => 'Meringue', 'ar' => 'مرينغ'],
            'lilie' => ['en' => 'Lily', 'ar' => 'زنبق'],
            'salz' => ['en' => 'Salt', 'ar' => 'ملح'],
            'weisse-blueten' => ['en' => 'White Flowers', 'ar' => 'زهور بيضاء'],
            'bitterorange' => ['en' => 'Bitter Orange', 'ar' => 'برتقال مر'],
            'himbeere' => ['en' => 'Raspberry', 'ar' => 'توت العليق'],
            'jasmin-sambac' => ['en' => 'Jasmine Sambac', 'ar' => 'ياسمين سامباك'],
            'neroli' => ['en' => 'Neroli', 'ar' => 'نيرولي'],
            'orangenbluete' => ['en' => 'Orange Blossom', 'ar' => 'زهر البرتقال'],
            'ambra' => ['en' => 'Amber', 'ar' => 'عنبر'],
            'gesalzene-vanille' => ['en' => 'Salted Vanilla', 'ar' => 'فانيليا مملحة'],
            'gruene-mandarine' => ['en' => 'Green Mandarin', 'ar' => 'يوسفي أخضر'],
            'kaschmirholz' => ['en' => 'Cashmere Wood', 'ar' => 'خشب الكشمير'],
            'wasserjasmin' => ['en' => 'Water Jasmine', 'ar' => 'ياسمين مائي'],
            'zieringwer' => ['en' => 'Ornamental Ginger', 'ar' => 'زنجبيل الزينة'],
            'birne' => ['en' => 'Pear', 'ar' => 'كمثرى'],
            'bourbon-vanille-absolue' => ['en' => 'Bourbon Vanilla Absolute', 'ar' => 'مطلق فانيليا بوربون'],
            'jasmin' => ['en' => 'Jasmine', 'ar' => 'ياسمين'],
            'karamell' => ['en' => 'Caramel', 'ar' => 'كراميل'],
            'lavendel' => ['en' => 'Lavender', 'ar' => 'لافندر'],
            'madagassische-mandarine' => ['en' => 'Madagascan Mandarin', 'ar' => 'يوسفي مدغشقري'],
            'madagassischer-ylang-ylang' => ['en' => 'Madagascan Ylang-Ylang', 'ar' => 'يلانغ يلانغ مدغشقري'],
            'moosige-noten' => ['en' => 'Mossy Notes', 'ar' => 'نفحات طحلبية'],
            'moschus' => ['en' => 'Musk', 'ar' => 'مسك'],
            'rosenoxid' => ['en' => 'Rose Oxide', 'ar' => 'أكسيد الورد'],
            'damaszener-rose' => ['en' => 'Damask Rose', 'ar' => 'وردة دمشقية'],
            'grasse-jasmin' => ['en' => 'Grasse Jasmine', 'ar' => 'ياسمين غراس'],
            'komorischer-ylang-ylang' => ['en' => 'Comoran Ylang-Ylang', 'ar' => 'يلانغ يلانغ قمري'],
            'kalabrische-bergamotte' => ['en' => 'Calabrian Bergamot', 'ar' => 'برغموت كالابري'],
            'maigloeckchen' => ['en' => 'Lily of the Valley', 'ar' => 'زنبق الوادي'],
            'pfingstrose' => ['en' => 'Peony', 'ar' => 'فاوانيا'],
            'sizilianische-mandarine' => ['en' => 'Sicilian Mandarin', 'ar' => 'يوسفي صقلي'],
            'weisser-moschus' => ['en' => 'White Musk', 'ar' => 'مسك أبيض'],
            'aprikose' => ['en' => 'Apricot', 'ar' => 'مشمش'],
            'bittermandel' => ['en' => 'Bitter Almond', 'ar' => 'لوز مر'],
            'kokosnuss' => ['en' => 'Coconut', 'ar' => 'جوز الهند'],
            'pflaume' => ['en' => 'Plum', 'ar' => 'برقوق'],
            'piment' => ['en' => 'Allspice', 'ar' => 'بهار حلو'],
            'rose' => ['en' => 'Rose', 'ar' => 'ورد'],
            'rosenholz' => ['en' => 'Rosewood', 'ar' => 'خشب الورد'],
            'sandelholz' => ['en' => 'Sandalwood', 'ar' => 'خشب الصندل'],
            'tuberose' => ['en' => 'Tuberose', 'ar' => 'توبروز'],
            'vanille' => ['en' => 'Vanilla', 'ar' => 'فانيليا'],
            'bergamotte' => ['en' => 'Bergamot', 'ar' => 'برغموت'],
            'mandarine' => ['en' => 'Mandarin', 'ar' => 'يوسفي'],
            'orange' => ['en' => 'Orange', 'ar' => 'برتقال'],
            'weisser-amber' => ['en' => 'White Amber', 'ar' => 'أمبر أبيض'],
            'zeder' => ['en' => 'Cedar', 'ar' => 'أرز'],
            'ananas' => ['en' => 'Pineapple', 'ar' => 'أناناس'],
            'kirsche' => ['en' => 'Cherry', 'ar' => 'كرز'],
            'popcorn' => ['en' => 'Popcorn', 'ar' => 'فشار'],
            'veilchen' => ['en' => 'Violet', 'ar' => 'بنفسج'],
            'walderdbeere' => ['en' => 'Wild Strawberry', 'ar' => 'فراولة برية'],
            'amber' => ['en' => 'Amber', 'ar' => 'أمبر'],
            'zedernholz' => ['en' => 'Cedarwood', 'ar' => 'خشب الأرز'],
            'kaffee' => ['en' => 'Coffee', 'ar' => 'قهوة'],
            'rosa-pfeffer' => ['en' => 'Pink Pepper', 'ar' => 'فلفل وردي'],
            'johannisbeere' => ['en' => 'Currant', 'ar' => 'كشمش'],
            'mimose' => ['en' => 'Mimosa', 'ar' => 'ميموزا'],
            'opoponax' => ['en' => 'Opoponax', 'ar' => 'أوبوبوناكس'],
            'tonkabohne' => ['en' => 'Tonka Bean', 'ar' => 'حبة التونكا'],
            'vetiver' => ['en' => 'Vetiver', 'ar' => 'فيتيفر'],
            'ylang-ylang' => ['en' => 'Ylang-Ylang', 'ar' => 'يلانغ يلانغ'],
            'iris' => ['en' => 'Iris', 'ar' => 'سوسن'],
            'teakholz' => ['en' => 'Teak Wood', 'ar' => 'خشب الساج'],
            'wasserhyazinthe' => ['en' => 'Water Hyacinth', 'ar' => 'ياقوتية الماء'],
            'zitrusfruechte' => ['en' => 'Citrus Fruits', 'ar' => 'فواكه حمضية'],
            'aldehyde' => ['en' => 'Aldehydes', 'ar' => 'ألدهيدات'],
            'zitrone' => ['en' => 'Lemon', 'ar' => 'ليمون'],
            'benzoe' => ['en' => 'Benzoin', 'ar' => 'بنزوين'],
            'magnolie' => ['en' => 'Magnolia', 'ar' => 'ماغنوليا'],
            'mandarinenbluete' => ['en' => 'Mandarin Blossom', 'ar' => 'زهر اليوسفي'],
            'schwarzer-pfeffer' => ['en' => 'Black Pepper', 'ar' => 'فلفل أسود'],
            'birnenbluete' => ['en' => 'Pear Blossom', 'ar' => 'زهر الكمثرى'],
            'brauner-zucker' => ['en' => 'Brown Sugar', 'ar' => 'سكر بني'],
            'frangipani' => ['en' => 'Frangipani', 'ar' => 'فرانجيباني'],
            'rote-beeren' => ['en' => 'Red Berries', 'ar' => 'توت أحمر'],
            'litschi' => ['en' => 'Lychee', 'ar' => 'ليتشي'],
            'madonnenlilie' => ['en' => 'Madonna Lily', 'ar' => 'زنبق مادونا'],
            'pfirsich' => ['en' => 'Peach', 'ar' => 'خوخ'],
            'kandierte-zitrone' => ['en' => 'Candied Lemon', 'ar' => 'ليمون مسكر'],
            'bourbon-vanille' => ['en' => 'Bourbon Vanilla', 'ar' => 'فانيليا بوربون'],
            'brombeere' => ['en' => 'Blackberry', 'ar' => 'توت أسود'],
            'erdbeere' => ['en' => 'Strawberry', 'ar' => 'فراولة'],
            'heidelbeere' => ['en' => 'Blueberry', 'ar' => 'توت أزرق'],
            'bulgarische-rose' => ['en' => 'Bulgarian Rose', 'ar' => 'وردة بلغارية'],
            'geroestete-tonkabohne' => ['en' => 'Roasted Tonka Bean', 'ar' => 'حبة تونكا محمصة'],
            'kakao' => ['en' => 'Cocoa', 'ar' => 'كاكاو'],
            'kaschmir' => ['en' => 'Cashmere', 'ar' => 'كشمير'],
            'mandel' => ['en' => 'Almond', 'ar' => 'لوز'],
            'praline' => ['en' => 'Praline', 'ar' => 'برالين'],
            'zimt' => ['en' => 'Cinnamon', 'ar' => 'قرفة'],
            'ingwer' => ['en' => 'Ginger', 'ar' => 'زنجبيل'],
            'pimentblatt' => ['en' => 'Allspice Leaf', 'ar' => 'ورق البهار'],
            'galbanum' => ['en' => 'Galbanum', 'ar' => 'جالبانوم'],
            'hyazinthe' => ['en' => 'Hyacinth', 'ar' => 'ياقوتية'],
            'freesie' => ['en' => 'Freesia', 'ar' => 'فريزيا'],
            'eichenmoos' => ['en' => 'Oakmoss', 'ar' => 'طحلب البلوط'],
            'grapefruit' => ['en' => 'Grapefruit', 'ar' => 'جريب فروت'],
            'tuerkische-damaszener-rose' => ['en' => 'Turkish Damask Rose', 'ar' => 'وردة دمشقية تركية'],
            'weihrauch' => ['en' => 'Incense', 'ar' => 'بخور'],
            'holzige-noten' => ['en' => 'Woody Notes', 'ar' => 'نفحات خشبية'],
            'moos' => ['en' => 'Moss', 'ar' => 'طحلب'],
            'ambroxan' => ['en' => 'Ambroxan', 'ar' => 'أمبروكسان'],
            'bitterorangenbluete' => ['en' => 'Bitter Orange Blossom', 'ar' => 'زهر البرتقال المر'],
            'jasmin-sambac-absolue' => ['en' => 'Jasmine Sambac Absolute', 'ar' => 'مطلق ياسمين سامباك'],
            'siam-benzoe' => ['en' => 'Siam Benzoin', 'ar' => 'بنزوين سيامي'],
            'tangerine' => ['en' => 'Tangerine', 'ar' => 'تنجرين'],
            'tunesische-orangenbluete-absolue' => ['en' => 'Tunisian Orange Blossom Absolute', 'ar' => 'مطلق زهر البرتقال التونسي'],
            'lotus' => ['en' => 'Lotus', 'ar' => 'لوتس'],
            'mairose' => ['en' => 'May Rose', 'ar' => 'وردة مايو'],
            'melone' => ['en' => 'Melon', 'ar' => 'شمام'],
            'quitte' => ['en' => 'Quince', 'ar' => 'سفرجل'],
            'schwarze-johannisbeere' => ['en' => 'Blackcurrant', 'ar' => 'كشمش أسود'],
            'seerose' => ['en' => 'Water Lily', 'ar' => 'زنبق الماء'],
            'veilchenwurzel' => ['en' => 'Orris Root', 'ar' => 'جذر السوسن'],
            'weissdorn' => ['en' => 'Hawthorn', 'ar' => 'زعرور'],
            'zitrische-noten' => ['en' => 'Citrus Notes', 'ar' => 'نفحات حمضية'],
            'cognac' => ['en' => 'Cognac', 'ar' => 'كونياك'],
            'kastanie' => ['en' => 'Chestnut', 'ar' => 'كستناء'],
            'seide' => ['en' => 'Silk', 'ar' => 'حرير'],
            'rote-pfingstrose' => ['en' => 'Red Peony', 'ar' => 'فاوانيا حمراء'],
            'tulpen' => ['en' => 'Tulip', 'ar' => 'توليب'],
            'kamelie' => ['en' => 'Camellia', 'ar' => 'كاميليا'],
            'puderzucker' => ['en' => 'Powdered Sugar', 'ar' => 'سكر ناعم'],
            'veilchenblatt' => ['en' => 'Violet Leaf', 'ar' => 'ورق البنفسج'],
            'aquatische-noten' => ['en' => 'Aquatic Notes', 'ar' => 'نفحات مائية'],
            'gruener-apfel' => ['en' => 'Green Apple', 'ar' => 'تفاح أخضر'],
            'vanillebluete' => ['en' => 'Vanilla Blossom', 'ar' => 'زهر الفانيليا'],
            'weisse-lilie' => ['en' => 'White Lily', 'ar' => 'زنبق أبيض'],
            'rangunschlinger' => ['en' => 'Rangoon Creeper', 'ar' => 'متسلقة رانغون'],
            'ambrette' => ['en' => 'Ambrette', 'ar' => 'أمبريت'],
            'italienische-bergamotte' => ['en' => 'Italian Bergamot', 'ar' => 'برغموت إيطالي'],
            'marshmallow' => ['en' => 'Marshmallow', 'ar' => 'مارشميلو'],
            'sahne' => ['en' => 'Cream', 'ar' => 'كريمة'],
            'ecuadorianisches-palo-santo' => ['en' => 'Ecuadorian Palo Santo', 'ar' => 'بالو سانتو إكوادوري'],
            'ambrox' => ['en' => 'Ambrox', 'ar' => 'أمبروكس'],
            'cripps-pink-apfel' => ['en' => 'Cripps Pink Apple', 'ar' => 'تفاح كريبس بينك'],
            'italienische-zitrone' => ['en' => 'Italian Lemon', 'ar' => 'ليمون إيطالي'],
            'nektarinenbluete' => ['en' => 'Nectarine Blossom', 'ar' => 'زهر النكتارين'],
            'orangenbluetenwasser' => ['en' => 'Orange Blossom Water', 'ar' => 'ماء زهر البرتقال'],
            'rosa-moschus' => ['en' => 'Pink Musk', 'ar' => 'مسك وردي'],
            'zucker' => ['en' => 'Sugar', 'ar' => 'سكر'],
            'alpenveilchen' => ['en' => 'Cyclamen', 'ar' => 'بخور مريم'],
            'exotische-hoelzer' => ['en' => 'Exotic Woods', 'ar' => 'أخشاب غريبة'],
            'gartennelke' => ['en' => 'Carnation', 'ar' => 'قرنفل'],
            'osmanthus' => ['en' => 'Osmanthus', 'ar' => 'أوزمانثوس'],
            'rosenwasser' => ['en' => 'Rose Water', 'ar' => 'ماء الورد'],
            'rum' => ['en' => 'Rum', 'ar' => 'روم'],
            'schwarze-orchidee' => ['en' => 'Black Orchid', 'ar' => 'أوركيد أسود'],
            'schwarze-pflaume' => ['en' => 'Black Plum', 'ar' => 'برقوق أسود'],
            'schwarze-trueffel' => ['en' => 'Black Truffle', 'ar' => 'كمأة سوداء'],
            'kardamom' => ['en' => 'Cardamom', 'ar' => 'هيل'],
            'pfeffer' => ['en' => 'Pepper', 'ar' => 'فلفل'],
            'apfel' => ['en' => 'Apple', 'ar' => 'تفاح'],
            'gurke' => ['en' => 'Cucumber', 'ar' => 'خيار'],
            'hoelzer' => ['en' => 'Woods', 'ar' => 'أخشاب'],
            'mandarinenblatt' => ['en' => 'Mandarin Leaf', 'ar' => 'ورق اليوسفي'],
            'tunesische-orangenbluete' => ['en' => 'Tunisian Orange Blossom', 'ar' => 'زهر البرتقال التونسي'],
            'indonesisches-patchouli' => ['en' => 'Indonesian Patchouli', 'ar' => 'باتشولي إندونيسي'],
            'marokkanischer-jasmin' => ['en' => 'Moroccan Jasmine', 'ar' => 'ياسمين مغربي'],
            'orangenbluete-absolue' => ['en' => 'Orange Blossom Absolute', 'ar' => 'مطلق زهر البرتقال'],
            'schwarzer-tee' => ['en' => 'Black Tea', 'ar' => 'شاي أسود'],
            'seychellenpalme' => ['en' => 'Sea Coconut', 'ar' => 'نخيل سيشل'],
            'cherry-hill-pfingstrose' => ['en' => 'Cherry Hill Peony', 'ar' => 'فاوانيا تشيري هيل'],
            'drachenfrucht' => ['en' => 'Dragon Fruit', 'ar' => 'فاكهة التنين'],
            'roter-frangipani' => ['en' => 'Red Frangipani', 'ar' => 'فرانجيباني أحمر'],
            'blumige-noten' => ['en' => 'Floral Notes', 'ar' => 'نفحات زهرية'],
            'gruene-birne' => ['en' => 'Green Pear', 'ar' => 'كمثرى خضراء'],
            'leder' => ['en' => 'Leather', 'ar' => 'جلد'],
            'roestaromen' => ['en' => 'Roasted Notes', 'ar' => 'نكهات محمصة'],
            'haitianisches-vetiver' => ['en' => 'Haitian Vetiver', 'ar' => 'فيتيفر هايتي'],
            'italienische-mandarine' => ['en' => 'Italian Mandarin', 'ar' => 'يوسفي إيطالي'],
            'weisser-pfirsich' => ['en' => 'White Peach', 'ar' => 'خوخ أبيض'],
            'estragon' => ['en' => 'Tarragon', 'ar' => 'طرخون'],
            'kuemmel' => ['en' => 'Caraway', 'ar' => 'كراوية'],
            'minze' => ['en' => 'Mint', 'ar' => 'نعناع'],
            'kokospalmenholz' => ['en' => 'Coconut Palm Wood', 'ar' => 'خشب نخيل جوز الهند'],
            'rosengeranie' => ['en' => 'Rose Geranium', 'ar' => 'إبرة الراعي الوردية'],
            'ceylon-zimt' => ['en' => 'Ceylon Cinnamon', 'ar' => 'قرفة سيلانية'],
            'chinesischer-schwarzer-tee-co2' => ['en' => 'Chinese Black Tea CO2', 'ar' => 'شاي أسود صيني CO2'],
            'nigerianischer-ingwer' => ['en' => 'Nigerian Ginger', 'ar' => 'زنجبيل نيجيري'],
            'sizilianische-zeder' => ['en' => 'Sicilian Cedar', 'ar' => 'أرز صقلي'],
            'tunesisches-neroli' => ['en' => 'Tunisian Neroli', 'ar' => 'نيرولي تونسي'],
            'oud' => ['en' => 'Oud', 'ar' => 'عود'],
            'pfefferminze' => ['en' => 'Peppermint', 'ar' => 'نعناع فلفلي'],
            'rose-absolue' => ['en' => 'Rose Absolute', 'ar' => 'مطلق الورد'],
            'rote-mandarine' => ['en' => 'Red Mandarin', 'ar' => 'يوسفي أحمر'],
            'fruchtige-noten' => ['en' => 'Fruity Notes', 'ar' => 'نفحات فواكهية'],
            'italienische-zitronenschale' => ['en' => 'Italian Lemon Zest', 'ar' => 'قشر ليمون إيطالي'],
            'muskatellersalbei' => ['en' => 'Clary Sage', 'ar' => 'مريمية مسكية'],
            'provenzalischer-lavendel-absolue' => ['en' => 'Provençal Lavender Absolute', 'ar' => 'مطلق لافندر بروفنسي'],
            'rhabarber' => ['en' => 'Rhubarb', 'ar' => 'راوند'],
            'vanille-absolue' => ['en' => 'Vanilla Absolute', 'ar' => 'مطلق الفانيليا'],
            'guajakholz' => ['en' => 'Guaiac Wood', 'ar' => 'خشب الغاياك'],
            'lorbeerblatt' => ['en' => 'Bay Leaf', 'ar' => 'ورق الغار'],
            'maritime-noten' => ['en' => 'Marine Notes', 'ar' => 'نفحات بحرية'],
            'geissblatt' => ['en' => 'Honeysuckle', 'ar' => 'زهر العسل'],
            'kamille' => ['en' => 'Chamomile', 'ar' => 'بابونج'],
            'muskat' => ['en' => 'Nutmeg', 'ar' => 'جوزة الطيب'],
            'muskatbluete' => ['en' => 'Mace', 'ar' => 'بسباسة'],
            'ecuadorianischer-ambrettesamen' => ['en' => 'Ecuadorian Ambrette Seed', 'ar' => 'بذور الأمبريت الإكوادورية'],
            'florentinische-schwertlilie-absolue' => ['en' => 'Florentine Iris Absolute', 'ar' => 'مطلق سوسن فلورنسي'],
            'virginiazeder' => ['en' => 'Virginia Cedar', 'ar' => 'أرز فرجيني'],
            'papua-neuguinea-vanille' => ['en' => 'Papua New Guinea Vanilla', 'ar' => 'فانيليا بابوا غينيا الجديدة'],
            'sternanis' => ['en' => 'Star Anise', 'ar' => 'يانسون نجمي'],
            'szechuanpfeffer' => ['en' => 'Sichuan Pepper', 'ar' => 'فلفل سيتشوان'],
            'bergamotteblatt' => ['en' => 'Bergamot Leaf', 'ar' => 'ورق البرغموت'],
            'koriandersamen' => ['en' => 'Coriander Seed', 'ar' => 'بذور الكزبرة'],
            'rosmarin' => ['en' => 'Rosemary', 'ar' => 'إكليل الجبل'],
            'salbei' => ['en' => 'Sage', 'ar' => 'مريمية'],
            'wuerzige-noten' => ['en' => 'Spicy Notes', 'ar' => 'نفحات حارة'],
            'glasierte-kastanie' => ['en' => 'Glazed Chestnut', 'ar' => 'كستناء مزججة'],
            'provenzalischer-lavendel' => ['en' => 'Provençal Lavender', 'ar' => 'لافندر بروفنسي'],
            'gruene-zitrone' => ['en' => 'Lime', 'ar' => 'ليمون أخضر'],
            'labdanum' => ['en' => 'Labdanum', 'ar' => 'لابدانوم'],
            'basilikum' => ['en' => 'Basil', 'ar' => 'ريحان'],
            'gruene-noten' => ['en' => 'Green Notes', 'ar' => 'نفحات خضراء'],
            'kiefernnadel' => ['en' => 'Pine Needle', 'ar' => 'إبرة الصنوبر'],
            'rosengeranienblatt' => ['en' => 'Rose Geranium Leaf', 'ar' => 'ورق إبرة الراعي الوردية'],
            'tannenbalsam' => ['en' => 'Fir Balsam', 'ar' => 'بلسم التنوب'],
            'thymian' => ['en' => 'Thyme', 'ar' => 'زعتر'],
            'wildleder' => ['en' => 'Suede', 'ar' => 'جلد الشمواه'],
            'zedernblatt' => ['en' => 'Cedar Leaf', 'ar' => 'ورق الأرز'],
            'mineralische-noten' => ['en' => 'Mineral Notes', 'ar' => 'نفحات معدنية'],
            'neukaledonisches-sandelholz' => ['en' => 'New Caledonian Sandalwood', 'ar' => 'خشب صندل كاليدوني جديد'],
            'meerwasser' => ['en' => 'Sea Water', 'ar' => 'ماء البحر'],
            'geranie' => ['en' => 'Geranium', 'ar' => 'إبرة الراعي'],
            'mango' => ['en' => 'Mango', 'ar' => 'مانجو'],
            'koriander' => ['en' => 'Coriander', 'ar' => 'كزبرة'],
            'atlaszeder' => ['en' => 'Atlas Cedar', 'ar' => 'أرز الأطلس'],
            'venezolanische-tonkabohne' => ['en' => 'Venezuelan Tonka Bean', 'ar' => 'حبة تونكا فنزويلية'],
            'birke' => ['en' => 'Birch', 'ar' => 'البتولا'],
            'gruener-tee' => ['en' => 'Green Tea', 'ar' => 'شاي أخضر'],
            'papaya' => ['en' => 'Papaya', 'ar' => 'بابايا'],
            'iriswurzel' => ['en' => 'Orris Root', 'ar' => 'جذر السوسن'],
            'kiefer' => ['en' => 'Pine', 'ar' => 'صنوبر'],
            'petitgrain' => ['en' => 'Petitgrain', 'ar' => 'بيتيغرين'],
            'wacholderbeere' => ['en' => 'Juniper Berry', 'ar' => 'حبة العرعر'],
            'blaetter' => ['en' => 'Leaves', 'ar' => 'أوراق'],
            'heliotrop' => ['en' => 'Heliotrope', 'ar' => 'هليوتروب'],
            'zypresse' => ['en' => 'Cypress', 'ar' => 'سرو'],
            'java-vetiver' => ['en' => 'Java Vetiver', 'ar' => 'فيتيفر جاوي'],
            'primofiore-zitrone' => ['en' => 'Primofiore Lemon', 'ar' => 'ليمون بريموفيوري'],
            'rum-absolue' => ['en' => 'Rum Absolute', 'ar' => 'مطلق الروم'],
            'styrax' => ['en' => 'Styrax', 'ar' => 'ستيراكس'],
            'tabak-absolue' => ['en' => 'Tobacco Absolute', 'ar' => 'مطلق التبغ'],
            'brasilianische-tonkabohne' => ['en' => 'Brazilian Tonka Bean', 'ar' => 'حبة تونكا برازيلية'],
            'cade-holz' => ['en' => 'Cade Wood', 'ar' => 'خشب الكاد'],
            'guatemala-kardamom' => ['en' => 'Guatemalan Cardamom', 'ar' => 'هيل غواتيمالي'],
            'kalabrische-zitrone' => ['en' => 'Calabrian Lemon', 'ar' => 'ليمون كالابري'],
            'kakao-absolue' => ['en' => 'Cocoa Absolute', 'ar' => 'مطلق الكاكاو'],
            'weisser-pfeffer' => ['en' => 'White Pepper', 'ar' => 'فلفل أبيض'],
            'elemiharz' => ['en' => 'Elemi Resin', 'ar' => 'راتنج الإيلمي'],
            'rosengeranie-absolue' => ['en' => 'Rose Geranium Absolute', 'ar' => 'مطلق إبرة الراعي الوردية'],
            'artemisia' => ['en' => 'Artemisia', 'ar' => 'شيح'],
            'calamondinorange' => ['en' => 'Calamondin Orange', 'ar' => 'برتقال كالامندين'],
            'ebenholz' => ['en' => 'Ebony', 'ar' => 'خشب الأبنوس'],
            'schwarzer-amber' => ['en' => 'Black Amber', 'ar' => 'أمبر أسود'],
            'schwarzer-kardamom' => ['en' => 'Black Cardamom', 'ar' => 'هيل أسود'],
            'tagetes' => ['en' => 'Tagetes', 'ar' => 'القطيفة'],
            'tolubalsam' => ['en' => 'Tolu Balsam', 'ar' => 'بلسم تولو'],
            'lorbeer' => ['en' => 'Laurel', 'ar' => 'غار'],
            'ringelblume' => ['en' => 'Marigold', 'ar' => 'آذريون'],
            'kulfi' => ['en' => 'Kulfi', 'ar' => 'كولفي'],
            'mastixharz' => ['en' => 'Mastic Resin', 'ar' => 'راتنج المستكة'],
            'safran' => ['en' => 'Saffron', 'ar' => 'زعفران'],
            'kreuzkuemmel' => ['en' => 'Cumin', 'ar' => 'كمون'],
            'agarholz-oud' => ['en' => 'Agarwood (Oud)', 'ar' => 'خشب العود (عود)'],
            'angelika' => ['en' => 'Angelica', 'ar' => 'أنجليكا'],
            'pinker-pfeffer' => ['en' => 'Pink Pepper', 'ar' => 'فلفل وردي'],
            'muskatnuss' => ['en' => 'Nutmeg', 'ar' => 'جوزة الطيب'],
            'suessholz-lakritze' => ['en' => 'Licorice', 'ar' => 'عرق السوس'],
            'patschuli' => ['en' => 'Patchouli', 'ar' => 'باتشولي'],
            'weisses-oud-synthetischhell' => ['en' => 'White Oud (Synthetic/Light)', 'ar' => 'عود أبيض (صناعي/فاتح)'],
            'florale-noten-oft-rose-oder-jasmin' => ['en' => 'Floral Notes (often Rose or Jasmine)', 'ar' => 'نفحات زهرية (غالباً ورد أو ياسمين)'],
            'leichte-zitrusnoten' => ['en' => 'Light Citrus Notes', 'ar' => 'نفحات حمضية خفيفة'],
            'schwarze-vanille' => ['en' => 'Black Vanilla', 'ar' => 'فانيليا سوداء'],
            'wacholder' => ['en' => 'Juniper', 'ar' => 'عرعر'],
            'virginia-zeder' => ['en' => 'Virginia Cedar', 'ar' => 'أرز فرجيني'],
            'atlas-zeder' => ['en' => 'Atlas Cedar', 'ar' => 'أرز الأطلس'],
            'himalaya-zeder' => ['en' => 'Himalayan Cedar', 'ar' => 'أرز الهيمالايا'],
            'labdanum-absolue' => ['en' => 'Labdanum Absolute', 'ar' => 'مطلق اللابدانوم'],
            'irisbutter' => ['en' => 'Iris Butter', 'ar' => 'زبدة السوسن'],
            'vanillin' => ['en' => 'Vanillin', 'ar' => 'فانيلين'],
            'chili' => ['en' => 'Chili', 'ar' => 'فلفل حار'],
            'amberholz' => ['en' => 'Amberwood', 'ar' => 'خشب الأمبر'],
            'davana' => ['en' => 'Davana', 'ar' => 'دافانا'],
            'oregano' => ['en' => 'Oregano', 'ar' => 'أوريغانو'],
            'zistrose' => ['en' => 'Cistus', 'ar' => 'لاذن'],
            'tuerkische-rose' => ['en' => 'Turkish Rose', 'ar' => 'وردة تركية'],
            'sizilianische-orange' => ['en' => 'Sicilian Orange', 'ar' => 'برتقال صقلي'],
            'sizilianische-zitrone' => ['en' => 'Sicilian Lemon', 'ar' => 'ليمون صقلي'],
            'getrocknete-fruechte' => ['en' => 'Dried Fruits', 'ar' => 'فواكه مجففة'],
            'harze' => ['en' => 'Resins', 'ar' => 'راتنجات'],
            'animalische-noten' => ['en' => 'Animalic Notes', 'ar' => 'نفحات حيوانية'],
            'indische-vanille' => ['en' => 'Indian Vanilla', 'ar' => 'فانيليا هندية'],
            'jasmin-absolue' => ['en' => 'Jasmine Absolute', 'ar' => 'مطلق الياسمين'],
            'kirsch-likoer' => ['en' => 'Cherry Liqueur', 'ar' => 'ليكير الكرز'],
            'perubalsam' => ['en' => 'Peru Balsam', 'ar' => 'بلسم البيرو'],
            'sauerkirschsirup' => ['en' => 'Sour Cherry Syrup', 'ar' => 'شراب الكرز الحامض'],
            'schwarzkirsche' => ['en' => 'Black Cherry', 'ar' => 'كرز أسود'],
            'helle-hoelzer' => ['en' => 'Light Woods', 'ar' => 'أخشاب فاتحة'],
            'sizilianische-blutorange' => ['en' => 'Sicilian Blood Orange', 'ar' => 'برتقال أحمر صقلي'],
            'tonkabohne-absolue' => ['en' => 'Tonka Bean Absolute', 'ar' => 'مطلق حبة التونكا'],
            'weinbergpfirsich' => ['en' => 'Vineyard Peach', 'ar' => 'خوخ الكروم'],
            'indischer-ingwer' => ['en' => 'Indian Ginger', 'ar' => 'زنجبيل هندي'],
            'indischer-jasmin-sambac-absolue' => ['en' => 'Indian Jasmine Sambac Absolute', 'ar' => 'مطلق ياسمين سامباك هندي'],
            'pistazie' => ['en' => 'Pistachio', 'ar' => 'فستق'],
            'sauerkirsche' => ['en' => 'Sour Cherry', 'ar' => 'كرز حامض'],
            'nepalesisches-oud' => ['en' => 'Nepalese Oud', 'ar' => 'عود نيبالي'],
            'rohrzucker' => ['en' => 'Cane Sugar', 'ar' => 'سكر القصب'],
            'ceylon-zimtblatt' => ['en' => 'Ceylon Cinnamon Leaf', 'ar' => 'ورق القرفة السيلانية'],
            'spanisches-labdanum' => ['en' => 'Spanish Labdanum', 'ar' => 'لابدانوم إسباني'],
            'zim' => ['en' => 'Cinnamon', 'ar' => 'قرفة'],
            'agarholz' => ['en' => 'Agarwood', 'ar' => 'خشب العود'],
            'beifuss' => ['en' => 'Mugwort', 'ar' => 'بعيثران'],
            'gurjanbalsam' => ['en' => 'Gurjun Balsam', 'ar' => 'بلسم الغرجن'],
            'hanf' => ['en' => 'Hemp', 'ar' => 'قنب'],
            'dattel' => ['en' => 'Date', 'ar' => 'تمر'],
            'myrrhe' => ['en' => 'Myrrh', 'ar' => 'مُرّ'],
            'balsamische-noten' => ['en' => 'Balsamic Notes', 'ar' => 'نفحات بلسمية'],
            'moschusnoten' => ['en' => 'Musk Notes', 'ar' => 'نفحات المسك'],
            'trockene-hoelzer' => ['en' => 'Dry Woods', 'ar' => 'أخشاب جافة'],
            'passionsfrucht' => ['en' => 'Passion Fruit', 'ar' => 'فاكهة الباشن'],
            'spanische-zistrose-absolue' => ['en' => 'Spanish Cistus Absolute', 'ar' => 'مطلق اللاذن الإسباني'],
            'tuerkische-rose-absolue' => ['en' => 'Turkish Rose Absolute', 'ar' => 'مطلق الوردة التركية'],
            'eiche' => ['en' => 'Oak', 'ar' => 'بلوط'],
            'himbeer-likoer' => ['en' => 'Raspberry Liqueur', 'ar' => 'ليكير توت العليق'],
            'indisches-sandelholz' => ['en' => 'Indian Sandalwood', 'ar' => 'خشب صندل هندي'],
            'sand' => ['en' => 'Sand', 'ar' => 'رمل'],
            'ambrettesamen-absolue' => ['en' => 'Ambrette Seed Absolute', 'ar' => 'مطلق بذور الأمبريت'],
            'damaszener-rose-absolue' => ['en' => 'Damask Rose Absolute', 'ar' => 'مطلق الوردة الدمشقية'],
            'granatapfel' => ['en' => 'Pomegranate', 'ar' => 'رمان'],
            'gruene-minze' => ['en' => 'Spearmint', 'ar' => 'نعناع أخضر'],
            'hibiskus' => ['en' => 'Hibiscus', 'ar' => 'كركديه'],
            'hibiskustee' => ['en' => 'Hibiscus Tea', 'ar' => 'شاي الكركديه'],
            'vanilleorchidee' => ['en' => 'Vanilla Orchid', 'ar' => 'أوركيد الفانيليا'],
            'schwarze-rose' => ['en' => 'Black Rose', 'ar' => 'وردة سوداء'],
            'schwarzer-trueffel' => ['en' => 'Black Truffle', 'ar' => 'كمأة سوداء'],
            'haselnuss' => ['en' => 'Hazelnut', 'ar' => 'بندق'],
            'schwarzes-leder' => ['en' => 'Black Leather', 'ar' => 'جلد أسود'],
            'weisses-moos' => ['en' => 'White Moss', 'ar' => 'طحلب أبيض'],
            'gewuerzter-rum' => ['en' => 'Spiced Rum', 'ar' => 'روم متبل'],
            'kandierter-apfel' => ['en' => 'Candied Apple', 'ar' => 'تفاح مسكر'],
            'mate' => ['en' => 'Mate', 'ar' => 'متة'],
            'schokolade' => ['en' => 'Chocolate', 'ar' => 'شوكولاتة'],
            'japanische-yuzu' => ['en' => 'Japanese Yuzu', 'ar' => 'يوزو ياباني'],
            'gewuerznelke' => ['en' => 'Clove', 'ar' => 'قرنفل'],
            'ambrettesamen' => ['en' => 'Ambrette Seed', 'ar' => 'بذور الأمبريت'],
            'feige' => ['en' => 'Fig', 'ar' => 'تين'],
            'moehrensamen' => ['en' => 'Carrot Seed', 'ar' => 'بذور الجزر'],
            'zitronatzitrone' => ['en' => 'Citron', 'ar' => 'أترج'],
            'mandelmilch' => ['en' => 'Almond Milk', 'ar' => 'حليب اللوز'],
            'nagarmotha' => ['en' => 'Nagarmotha', 'ar' => 'ناغارموثا'],
            'heller-tabak' => ['en' => 'Light Tobacco', 'ar' => 'تبغ فاتح'],
            'anis' => ['en' => 'Anise', 'ar' => 'يانسون'],
            'papyrus' => ['en' => 'Papyrus', 'ar' => 'بردي'],
            'provenzalischer-honig-absolue' => ['en' => 'Provençal Honey Absolute', 'ar' => 'مطلق العسل البروفنسي'],
            'somalischer-weihrauch' => ['en' => 'Somali Incense', 'ar' => 'بخور صومالي'],
            'rosenlokum' => ['en' => 'Rose Lokum', 'ar' => 'ملبن الورد'],
            'suessholz' => ['en' => 'Licorice', 'ar' => 'عرق السوس'],
            'bulgarische-damaszener-rose' => ['en' => 'Bulgarian Damask Rose', 'ar' => 'وردة دمشقية بلغارية'],
            'tuerkische-damaszener-rose-absolue' => ['en' => 'Turkish Damask Rose Absolute', 'ar' => 'مطلق الوردة الدمشقية التركية'],
            'laotisches-oud' => ['en' => 'Laotian Oud', 'ar' => 'عود لاوسي'],
            'duftnoten-bergamotte' => ['en' => 'Fragrance Notes: Bergamot', 'ar' => 'نفحات عطرية: برغموت'],
            'kakaoblatt' => ['en' => 'Cocoa Leaf', 'ar' => 'ورق الكاكاو'],
            'opium' => ['en' => 'Opium', 'ar' => 'أفيون'],
            'wermutkraut' => ['en' => 'Wormwood', 'ar' => 'أفسنتين'],
            'eisenkraut' => ['en' => 'Verbena', 'ar' => 'لويزة'],
            'cappuccino' => ['en' => 'Cappuccino', 'ar' => 'كابتشينو'],
            'cypriol' => ['en' => 'Cypriol', 'ar' => 'سيبريول'],
        ];
    }
}
