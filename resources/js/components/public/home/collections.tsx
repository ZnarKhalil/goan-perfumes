                    ...
                    {categories.map((category, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(7,5,4,0.08)_0%,rgba(7,5,4,0.18)_45%,rgba(7,5,4,0.88)_100%)] transition-opacity duration-700 group-hover:opacity-90" />
