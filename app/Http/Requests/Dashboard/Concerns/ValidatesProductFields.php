    ...
    protected function productRules(): array
    {
        return array_merge(
            [
                ...
                'media_meta.existing.*.alt_text.de' => ['nullable', 'string', 'max:255'],
                'media_meta.existing.*.alt_text.ar' => ['nullable', 'string', 'max:255'],
                'media_meta.existing.*.alt_text.en' => ['nullable', 'string', 'max:255'],
                ...
                'media_meta.new.*.alt_text.de' => ['nullable', 'string', 'max:255'],
                'media_meta.new.*.alt_text.ar' => ['nullable', 'string', 'max:255'],
                'media_meta.new.*.alt_text.en' => ['nullable', 'string', 'max:255'],
